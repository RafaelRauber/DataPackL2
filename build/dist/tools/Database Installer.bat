...
echo. ---------------------------------------------------------------------
echo.
echo.   L2Guardian - Database Login Server
echo. _____________________________________________________________________
echo.
echo.   1 - Full install database loginserver.
...
echo. ---------------------------------------------------------------------
echo.
echo.   L2Guardian - database operation about gameserver
echo. _____________________________________________________________________
echo.
echo.   1 - Full Install Gameserver Database.
...
echo Now be install Guardian database gameserver.
pause
...
echo *** Sucesfull 1 percents. ***
%mysqlPath% -h %gshost% -u %gsuser% --password=%gspass% -D %gsdb% < ../sql/achievements.sql
...
%mysqlPath% -h %gshost% -u %gsuser% --password=%gspass% -D %gsdb% < ../sql/monuments_startup.sql
